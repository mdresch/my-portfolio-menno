---
coverImage: "/images/_6353c4cd-dedc-427a-886d-7b5114c241d3.jpg"
title: "📘 RPAS‑CM‑OPM‑001 v1.0.0 (CSR‑42)"
date: 2026-05-02
slug: "adpa-governance-rpas-opm"
description: "This is your guide to working with AI agents inside the ADPA framework. ADPA uses a governance system called RPAS (Regulated Process Assurance System) that controls how AI agents behave when they help you write code, fix bugs, update configuration, or perform any other task."
categories:
  - ADPA
  - Governance
  - RPAS
...
sourcePath: "governance/RPAS-OPM.md"
---
> **Source:** [`governance/RPAS-OPM.md`](https://github.com/mdresch/adpa/blob/adpa-project-charter/governance/RPAS-OPM.md) — branch `adpa-project-charter`, repository [mdresch/adpa](https://github.com/mdresch/adpa).
