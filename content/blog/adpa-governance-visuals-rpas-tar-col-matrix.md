---
coverImage: "/images/_95144f5e-bd9e-40cb-bebe-ebfaa50e1b86.jpeg"
title: "📊 RPAS‑TAR‑COL Collision Matrix"
date: 2026-05-02
slug: "adpa-governance-visuals-rpas-tar-col-matrix"
description: "This matrix maps the Collision‑Prevention (CP) measures of the TAR‑COL‑001 protocol against the primary failure modes in multi‑agent and multi‑tier environments."
categories:
  - ADPA
  - Governance
  - RPAS
...
sourcePath: "governance/visuals/RPAS-TAR-COL-Matrix.md"
---
> **Source:** [`governance/visuals/RPAS-TAR-COL-Matrix.md`](https://github.com/mdresch/adpa/blob/adpa-project-charter/governance/visuals/RPAS-TAR-COL-Matrix.md) — branch `adpa-project-charter`, repository [mdresch/adpa](https://github.com/mdresch/adpa).
