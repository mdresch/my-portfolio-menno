---
coverImage: "/images/_54f9b5e8-74e4-4fa9-b8d8-a09e7f4828dc.jpg"
title: "✅ RPAS‑CM‑ESC‑001 v1.0.0 (CSR‑42)"
date: 2026-05-02
slug: "adpa-governance-rpas-esc"
description: "Agents operating under RPAS‑CM governance encounter ambiguous situations: unclear scope, multi‑intent requests, unfamiliar architecture, or conflicting constraints. Without an explicit protocol, agents resolve ambiguity through self‑interpretation — guessing, inferring, or \"helpf"
categories:
  - ADPA
  - Governance
  - RPAS
...
sourcePath: "governance/RPAS-ESC.md"
---
> **Source:** [`governance/RPAS-ESC.md`](https://github.com/mdresch/adpa/blob/adpa-project-charter/governance/RPAS-ESC.md) — branch `adpa-project-charter`, repository [mdresch/adpa](https://github.com/mdresch/adpa).
