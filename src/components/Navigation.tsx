...
function DarkModeToggle() {
  ...
  return (
    <button
      ...
      className="ml-4 px-3 py-1.5 rounded-lg text-sm font-medium border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-indigo-700 dark:text-indigo-200 hover:bg-indigo-50 dark:hover:bg-gray-700 transition-colors shadow-sm"
