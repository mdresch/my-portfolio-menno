...
export default function BalanceOfTradeDashboard() {
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Balance of Trade Dashboard</h1>
        ...
        <table className="min-w-full border border-gray-300">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="px-4 py-2 border">Major Foreign Investors</th>
              <th className="px-4 py-2 border">Trade Deficit</th>
            </tr>
          </thead>
          <tbody>
            {tradeData.map((row) => (
              <tr key={row.country}>
                <td className="px-4 py-2 border font-semibold">{row.country}</td>
                <td className="px-4 py-2 border">{row.majorInvestors.join(", ")}</td>
                <td className="px-4 py-2 border">{row.tradeDeficit}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <section className="my-8 p-6 bg-blue-50 rounded">
        <h2 className="text-2xl font-semibold mb-2">Insights into the Economics of Imports</h2>
        <h3 className="text-xl font-semibold mt-4 mb-1">Goods Imports</h3>
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Services Imports</h3>
        <ul className="list-disc ml-6 mb-4 text-gray-800">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Economic Impacts</h3>
      ...
      <section className="my-8 p-6 bg-green-50 rounded">
        <h2 className="text-2xl font-semibold mb-2">Insights into the Economics of Exports</h2>
        <h3 className="text-xl font-semibold mt-4 mb-1">Goods Exports</h3>
        <ul className="list-disc ml-6 mb-4 text-gray-800">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Services Exports</h3>
        <ul className="list-disc ml-6 mb-4 text-gray-800">
      ...
      <section className="my-8 p-6 bg-yellow-50 rounded">
        <h2 className="text-2xl font-semibold mb-2">What do you think is the biggest cause of trade deficits? 🤔</h2>
        <p className="mb-4 text-gray-700">You can see how people vote. Learn more</p>
        <ul className="list-disc ml-6 mb-4 text-gray-800">
